...
const SvgSkipBack = ({
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M19.573 9.86V7.573a.574.574 0 0 0-.956-.426l-3.434 3.434a.578.578 0 0 0-.189.425c.001.162.07.317.19.425l3.436 3.43a.567.567 0 0 0 .616.097.57.57 0 0 0 .34-.522V12.5H20c5.523 0 9.5 3.977 9.5 9.5s-3.977 9.5-9.5 9.5-9.5-3.977-9.5-9.5c0-2-2.5-2-2.5 0 0 6.627 5.373 12 12 12s12-5.373 12-12-5.373-12-12-12h-.427v-.14Z"
      fill="currentColor"
    />
    <path
